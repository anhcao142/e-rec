...
{\hat r_{u,i}} = \;\mu  + \;{b_i} + \;{b_u} + q_i^T\left( {{p_u} + {{\left| {{N_u}} \right|}^{ - \frac{1}{2}}}\sum\limits_{j \in {N_u}} {{y_j}} } \right)
\end{eqnarray}
Note that each time the model is updated, the overall average rating changes. So in equation~\ref{eq:isvd++_pre1}, $\mu$ is calculated at the last update of user $u$'s factors. 
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{"exp5_RMSE".jpg} 
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{"exp5_time".jpg} 
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{"exp1_RMSE".jpg} 
    \caption{ Recommendation accuracy (RMSE) comparison between the proposed Incremental SVD++ and SVD++ algorithm in MovieLens}
    \label{fig:exp1_RMSE}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{"exp1_time".jpg} 
    \caption{ Training time comparison between the proposed Incremental SVD++ and SVD++ algorithm in MovieLens}
    \label{fig:exp1_time}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{"exp4_RMSE".jpg} 
    \caption{ Recommendation accuracy (RMSE) comparison between the proposed Incremental SVD++ and SVD++ algorithm in MovieLens}
    \label{fig:exp4_RMSE}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{"exp4_time".jpg} 
    \caption{ Training time comparison between the proposed Incremental SVD++ and SVD++ algorithm in MovieLens}
    \label{fig:exp4_time}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{"exp7_5".jpg} 
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{"exp7_123".jpg} 
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{"exp7_4".jpg} 
    \caption{ Update times of Incremental SVD++}
    \label{fig:exp7_4}
\end{figure}
