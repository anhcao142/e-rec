...
\begin{algorithm}[H]
 ...
 \Repeat{convergence}{
	...
	{ 
		\If{$u \in Q$}
		{
			$\begin{array}{l}{b_u} \leftarrow {b_u} + {\rm{\;}}{\gamma _1}.\left( {{e_{ui}} - {\rm{\;}}{\lambda _1}.{b_u}} \right)\\{p_u} \leftarrow {p_u} + {\rm{\;}}{\gamma _2}.\left( {{e_{ui}}.{q_i} - {\lambda _2}.{p_u}} \right)\\\forall j \in {N_u}:\\{y_j} \leftarrow {y_j} + {\rm{\;}}{\gamma _2}.\left( {{e_{ui}}.{{\left| {{N_u}} \right|}^{ - \frac{1}{2}}}.{q_i} - {\lambda _2}.{y_j}} \right)\end{array}$
		}
		\If{$i \in Q$}
		{
		$\begin{array}{l}{b_i} \leftarrow {b_i} + {\rm{\;}}{\gamma _1}.\left( {{e_{ui}} - {\rm{\;}}{\lambda _1}.{b_i}} \right)\\{q_i} \leftarrow {q_i} + {\rm{\;}}{\gamma _2}.\left( {{e_{ui}}.\left( {{p_u} + {{\left| {{N_u}} \right|}^{ - \frac{1}{2}}}\sum\limits_{j \in  \in {N_u}} {{y_j}} } \right) - {\lambda _2}.{q_i}} \right)\end{array}$ 
		}
	}
}
